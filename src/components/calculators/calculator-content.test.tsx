...
describe("calculator explanatory content", () => {
  it("explains the jeonse increase formula and its legal limitation", () => {
  ...
  it("explains the interest-only formula and excluded costs", () => {
  ...
  it("explains that existing and additional loan portions are calculated separately", () => {
