...
const calculators: Array<{
  ...
  { index: "03", title: "전세대출 한도 간단 추정", description: "전세보증금과 LTV 비율로 예상 대출 가능 금액과 필요한 자기 자금을 확인하세요.", href: "/calculators/loan-limit", icon: "calculator", iconLabel: "대출 한도 계산기" },
  { index: "04", title: "전세대출 월 이자 계산", description: "대출 원금과 금리를 넣고 매달 낼 예상 이자를 바로 확인하세요.", href: "/calculators/loan-interest", icon: "calculator", iconLabel: "이자 계산기" },
  { index: "05", title: "대출 늘리면 이자 얼마나 늘까", description: "기존 대출과 증액분 금리가 다를 때 월 이자 변화부터 비교하세요.", href: "/calculators/loan-increase", icon: "compare", iconLabel: "증액 이자 계산기" },
];
const guides = [
...
const situations = [
  ...
  { index: "03", label: "전세대출 한도 간단 추정", href: "/calculators/loan-limit" },
];
