...
export default function HomePage() {
  return <main>
    <section className="hero"><div className="hero-inner"><div><span className="eyebrow">공식 출처 기반 주거금융 도구</span><h1 className="hero-copy-desktop">전세보증금과<br />대출 이자를 바로 계산하세요</h1><h1 className="hero-copy-mobile hero-mobile-title"><span className="hero-keyword">전세금</span>과<br /><span className="hero-keyword">대출 이자</span>를<br />한눈에 계산하세요</h1><p className="hero-copy-desktop">복잡한 주거금융 정보를 계산 근거, 확인일, 공식 원문과 함께 제공합니다.</p><p className="hero-copy-mobile">예상 계산값과 공식 확인 자료를 한곳에서 제공합니다.</p><div className="situation-links" aria-label="자주 찾는 상황"><Link href="/calculators/jeonse-increase">보증금 5% 넘는지 확인</Link><Link href="/calculators/loan-interest">월 이자가 얼마인지 계산</Link><Link href="/calculators/loan-increase">대출을 늘리면 이자 변화 확인</Link></div><div className="hero-actions"><Link className="primary-link" href="#calculators">계산기 선택</Link><Link className="secondary-link" href="/guides">금융 가이드 보기</Link></div></div><div className="trust-card"><span className="hero-copy-desktop">개인정보 보호 원칙</span><span className="hero-copy-mobile">브라우저에서만 계산</span><strong className="hero-copy-desktop">입력값은 저장하거나 전송하지 않습니다.</strong><strong className="hero-copy-mobile">입력한 금액과 금리는 외부로 전송되지 않습니다.</strong><p>모든 계산은 현재 브라우저 안에서만 처리됩니다.</p><div><span>공식 출처</span><b>HF · HUG · SGI · 법제처</b></div><div><span>최근 확인</span><b>2026-06-11</b></div></div></div></section>
