...
const calculators: Array<{
  ...
  { index: "02", title: "전세대출 월 이자 계산", description: "대출 원금과 금리를 넣고 매달 낼 예상 이자를 바로 확인하세요.", href: "/calculators/loan-interest", icon: "calculator", iconLabel: "이자 계산기" },
  { index: "03", title: "대출 늘리면 이자 얼마나 늘까", description: "기존 대출과 증액분 금리가 다를 때 월 이자 변화부터 비교하세요.", href: "/calculators/loan-increase", icon: "compare", iconLabel: "한도 비교 계산기" },
];
const guides = [
